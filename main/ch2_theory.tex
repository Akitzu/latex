...
\begin{figure}[h!]
    \subfloat[W7-X, $\nfp = 5$]{\label{fig:w7x-default}
        \includegraphics[width=0.3\textwidth]{images/theory/w7x.png}
    }
    \hfill
    \subfloat[NCSX, $\nfp = 3$]{\label{fig:ncsx-default}
        \includegraphics[width=0.3\textwidth]{images/theory/ncsx.png}
    }
    \hfill
    \subfloat[LHD, $\nfp = 10$]{%
        \includegraphics[width=0.3\textwidth]{images/theory/lhd.png}
    }
...
\begin{figure}[h!]
    \subfloat[First sub-figure]{%
        \includegraphics[width=0.5\textwidth]{images/plots/toytok-pert/perturbation.png}
    }
    \hfill
    \subfloat[First sub-figure]{%
        \includegraphics[width=0.5\textwidth]{images/plots/toytok-6-1/poincare.png}
    }
    \caption{}
\end{figure}
